...
var serviceAccount = require('../firebase/nursingeducation-984dd-firebase-adminsdk-rx37q-2590664de0.json');
admin.initializeApp({
...
cron.schedule("0 19 * * *", async function () {
  ...
  studyReminderToken = studyReminderToken.filter(value => value !== undefined)
